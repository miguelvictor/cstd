        ...
        <div class="container" style="margin-top: 40px; margin-bottom: 40px;">
            <div class="row">
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <form action="/attractions/create.php" method="post" class="form-horizontal" style="text-align: center;" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Name</label>
                            <input name="name" class="form-control" placeholder="Enter attraction name" />
                        </div>
                        <div class="form-group">
                            <label>Description</label>
                            <textarea name="description" class="form-control" placeholder="Enter attraction's description"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Picture</label>
                            <input type="file" name="picture" class="form-control" accept="image/*" />
                        </div>
                        <button type="submit" class="btn btn-primary" style="margin-top: 30px;">Create Attraction</button>
                    </form>
                </div>
            </div>
        </div>
